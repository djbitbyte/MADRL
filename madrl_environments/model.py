...
class Critic(nn.Module):
    def __init__(self, n_agent, dim_observation, dim_action):
        ...
        self.FC1 = nn.Linear(obs_dim, 1024)  # 1024
        self.FC2 = nn.Linear(1024+act_dim, 512)  # 512
        self.FC3 = nn.Linear(512, 300)  # 300
...
class Actor(nn.Module):
    def __init__(self, dim_observation, dim_action):
        ...
        self.FC1 = nn.Linear(dim_observation, 500)  # 500
        self.FC2 = nn.Linear(500, 128)  # 128
